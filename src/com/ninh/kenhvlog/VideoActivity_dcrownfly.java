...
import com.blundell.tut.service.task.GetYouTubeUserVideosannguy;
import com.blundell.tut.service.task.GetYouTubeUserVideosdcrownfly;
...
import com.blundell.tut.service.task.GetYouTubeUserVideosjv;
import com.blundell.tut.service.task.GetYouTubeUserVideosray;
...
public class VideoActivity_dcrownfly extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_dcrownfly);
		_context = VideoActivity_dcrownfly.this;
		_activity = this;
		...
		findViewById(R.id.btnhelp).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View v) {
						Intent intent = new Intent(VideoActivity_dcrownfly.this,
								helpscr.class);
	...
	public void getUserYouTubeFeed(View v) {
		...
		new Thread(new GetYouTubeUserVideosdcrownfly(responseHandler, "blundellp"))
				.start();
