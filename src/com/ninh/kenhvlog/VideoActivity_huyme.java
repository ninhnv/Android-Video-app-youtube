...
public class VideoActivity_huyme extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_huyme);
		_context = VideoActivity_huyme.this;
		_activity = this;
		...
		findViewById(R.id.btnhelp).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View v) {
						Intent intent = new Intent(VideoActivity_huyme.this,
								helpscr.class);
	...
	public void getUserYouTubeFeed(View v) {
		...
		new Thread(new GetYouTubeUserVideoshuyme(responseHandler, "blundellp"))
				.start();
