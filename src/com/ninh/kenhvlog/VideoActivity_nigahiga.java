...
import com.blundell.tut.service.task.GetYouTubeUserVideosnigahiga;
...
public class VideoActivity_nigahiga extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_nigahiga);
		_context = VideoActivity_nigahiga.this;
		_activity = this;
		...
		findViewById(R.id.btnhelp).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View v) {
						Intent intent = new Intent(VideoActivity_nigahiga.this,
								helpscr.class);
	...
	public void getUserYouTubeFeed(View v) {
		...
		new Thread(new GetYouTubeUserVideosnigahiga(responseHandler, "blundellp"))
				.start();
