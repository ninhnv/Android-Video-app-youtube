...
public class VideoActivity_ray extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_ray);
		_context = VideoActivity_ray.this;
		_activity = this;
		...
		findViewById(R.id.btnhelp).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View v) {
						Intent intent = new Intent(VideoActivity_ray.this,
								helpscr.class);
	...
	public void getUserYouTubeFeed(View v) {
		...
		new Thread(new GetYouTubeUserVideosray(responseHandler, "blundellp"))
				.start();
