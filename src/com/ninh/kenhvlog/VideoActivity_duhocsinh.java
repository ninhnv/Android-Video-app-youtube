...
import com.blundell.tut.service.task.GetYouTubeUserVideosdhsm;
...
public class VideoActivity_duhocsinh extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_duhocsinh);
		_context = VideoActivity_duhocsinh.this;
		_activity = this;
		...
		findViewById(R.id.btnhelp).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View v) {
						Intent intent = new Intent(VideoActivity_duhocsinh.this,
								helpscr.class);
	...
	public void getUserYouTubeFeed(View v) {
		...
		new Thread(new GetYouTubeUserVideosdhsm(responseHandler, "blundellp"))
				.start();
