 ...
 */
public class GetYouTubeUserVideosray implements Runnable {
	 ...
	 */
	public GetYouTubeUserVideosray(Handler replyTo, String username) {
...
//	@Override
	public void run() {
		try {
			...
			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/hieuvuong92/uploads?v=2&alt=jsonc");
