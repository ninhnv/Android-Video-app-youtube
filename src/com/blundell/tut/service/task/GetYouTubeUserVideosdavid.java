 ...
 */
public class GetYouTubeUserVideosdavid implements Runnable {
	 ...
	 */
	public GetYouTubeUserVideosdavid(Handler replyTo, String username) {
...
//	@Override
	public void run() {
		try {
			...
			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/DavidSoComedy/uploads?v=2&alt=jsonc");
