 ...
 */
public class GetYouTubeUserVideoslamvietanh implements Runnable {
	 ...
	 */
	public GetYouTubeUserVideoslamvietanh(Handler replyTo, String username) {
...
//	@Override
	public void run() {
		try {
			...
			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/lamvietanh/uploads?v=2&alt=jsonc");
