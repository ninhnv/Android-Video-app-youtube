 ...
 */
public class GetYouTubeUserVideosnigahiga implements Runnable {
	 ...
	 */
	public GetYouTubeUserVideosnigahiga(Handler replyTo, String username) {
...
//	@Override
	public void run() {
		try {
			...
			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/nigahiga/uploads?v=2&alt=jsonc");
