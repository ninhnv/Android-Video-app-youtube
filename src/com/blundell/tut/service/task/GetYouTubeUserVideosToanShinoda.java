 ...
 */
public class GetYouTubeUserVideosToanShinoda implements Runnable {
	 ...
	 */
	public GetYouTubeUserVideosToanShinoda(Handler replyTo, String username) {
...
//	@Override
	public void run() {
		try {
			...
			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/bnnkhardcore/uploads?v=2&alt=jsonc");
