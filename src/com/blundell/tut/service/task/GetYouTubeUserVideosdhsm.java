 ...
 */
public class GetYouTubeUserVideosdhsm implements Runnable {
	 ...
	 */
	public GetYouTubeUserVideosdhsm(Handler replyTo, String username) {
...
//	@Override
	public void run() {
		try {
			...
			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/duhocsinhmy/uploads?v=2&alt=jsonc");
