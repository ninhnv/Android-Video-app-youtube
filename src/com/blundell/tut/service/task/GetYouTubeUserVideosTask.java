...
//			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/ngovanninh/uploads?v=2&alt=jsonc");
			//http://gdata.youtube.com/feeds/api/users/JVevermind/uploads?v=2&alt=jsonc
//			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/HuyMeProductions/uploads?v=2&alt=jsonc");
