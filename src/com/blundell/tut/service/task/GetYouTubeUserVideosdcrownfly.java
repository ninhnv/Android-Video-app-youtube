 ...
 */
public class GetYouTubeUserVideosdcrownfly implements Runnable {
	 ...
	 */
	public GetYouTubeUserVideosdcrownfly(Handler replyTo, String username) {
...
//	@Override
	public void run() {
		try {
			...
			HttpUriRequest request = new HttpGet("http://gdata.youtube.com/feeds/api/users/dcrownfly/uploads?v=2&alt=jsonc");
